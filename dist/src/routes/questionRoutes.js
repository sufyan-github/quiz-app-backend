...
router.get('/', authMiddleware_1.authenticate, authMiddleware_1.requireAdmin, questionController_1.getQuestions);
...
router.patch('/:id/archive', authMiddleware_1.authenticate, authMiddleware_1.requireAdmin, questionController_1.archiveQuestion);
