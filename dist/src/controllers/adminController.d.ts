...
export declare const getAdminSmsLogs: (req: AuthRequest, res: Response) => Promise<void>;
...
export declare const getAdminQuizConfigs: (_req: AuthRequest, res: Response) => Promise<void>;
export declare const upsertAdminQuizConfig: (req: AuthRequest, res: Response) => Promise<void>;
