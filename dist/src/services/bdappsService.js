...
exports.bdappsService = {
    ...
    async sendOtp(subscriberId, digits) {
        ...
        try {
            ...
            const response = await phpGatewayClient_1.phpGatewayClient.post('/otp_request.php', {
    ...
    async verifyOtp(referenceNo, otp) {
        ...
        try {
            ...
            const response = await phpGatewayClient_1.phpGatewayClient.post('/otp_verify.php', {
                referenceNo,
                otp
            });
    ...
    async checkSubscription(subscriberId) {
        ...
        try {
            ...
            const response = await phpGatewayClient_1.phpGatewayClient.post('/status.php', {
                subscriberId: formattedSubId
            });
