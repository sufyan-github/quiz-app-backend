...
import { getExams, createExam, startExam, saveAnswer, submitExam, generateCertificate, updateExam, deleteExam, getAllResults, addQuestionToExam, deleteQuestion } from '../controllers/examController';
